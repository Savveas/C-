...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         en_en[5];   //[en]
   Int_t           en_id[5];   //[en]
   Float_t         en_cor_en[5];   //[en]
   Float_t         en_EtaSC[5];   //[en]
   Float_t         en_R9[5];   //[en]
   Int_t           en_gainSeed[5];   //[en]
   Bool_t          en_passId[5];   //[en]
   Bool_t          en_passIdLoose[5];   //[en]
   Bool_t          en_passIso[5];   //[en]
   Float_t         en_relIso[5];   //[en]
   Float_t         en_enSigmaValue[5];   //[en]
   Float_t         en_enScaleValue[5];   //[en]
   Float_t         en_enScaleStatUp[5];   //[en]
   Float_t         en_enScaleStatDown[5];   //[en]
   Float_t         en_enScaleSystUp[5];   //[en]
   Float_t         en_enScaleSystDown[5];   //[en]
   Float_t         en_enScaleGainUp[5];   //[en]
   Float_t         en_enScaleGainDown[5];   //[en]
   ...
   Float_t         jet_pz[25];   //[jet]
   Float_t         jet_en[25];   //[jet]
   Float_t         jet_btag0[25];   //[jet]
   Float_t         jet_btag1[25];   //[jet]
   Float_t         jet_mass[25];   //[jet]
   Float_t         jet_area[25];   //[jet]
   Float_t         jet_pu[25];   //[jet]
   Float_t         jet_puId[25];   //[jet]
   Bool_t          jet_PFLoose[25];   //[jet]
   Bool_t          jet_PFTight[25];   //[jet]
   Int_t           jet_partonFlavour[25];   //[jet]
   Int_t           jet_hadronFlavour[25];   //[jet]
   Int_t           jet_mother_id[25];   //[jet]
   Float_t         jet_parton_px[25];   //[jet]
   Float_t         jet_parton_py[25];   //[jet]
   Float_t         jet_parton_pz[25];   //[jet]
   Float_t         jet_parton_en[25];   //[jet]
   Float_t         jet_genpt[25];   //[jet]
   Float_t         imet_pt[11];
   Float_t         imet_phi[11];
   Float_t         met_pt;
   Float_t         met_phi;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("analysis_back_WJetsToLNu_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("analysis_back_WJetsToLNu_0.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("analysis_back_WJetsToLNu_0.root:/mainNtuplizer");
