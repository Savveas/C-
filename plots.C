...
void plots(){
  ...
  TCanvas *c_b_jets_pt = new TCanvas("jets","jets",1000,1000);
  ...
  TCanvas *c_jets2_pt = new TCanvas("jets","jets",1000,1000);
  ...
  TCanvas *c_b_jets2_pt = new TCanvas("jets","jets",1000,1000);
  ...
  TCanvas *c_jets3_pt = new TCanvas("jets","jets",1000,1000);
  ...
  TCanvas *c_b_jets3_pt = new TCanvas("jets","jets",1000,1000);
  ...
  TCanvas *c_jets4_pt = new TCanvas("jets","jets",1000,1000);
  ...
  TCanvas *c_b_jets4_pt = new TCanvas("jets","jets",1000,1000);
  ...
  hsig_b_jet1_eta->Draw("Ehist,same");
  ...
  hsig_jet1_eta->Scale(1./hsig_jet4_eta->Integral());
  ...
  hsig_b_jet1_m->Scale(1./hsig_b_jet1_m->Integral());
  ...
  hsig_b_jet2_m->Scale(1./hsig_b_jet2_m->Integral());
  ...
  hbkg_b_jet2_m->Scale(1./hbkg_b_jet2_m->Integral());
  ...
  hsig_jet3_m->Scale(1./hsig_jet3_m->Integral());
  hsig_jet3_m->Draw("Ehist");
  hsig_jet3_m->GetXaxis()->SetTitle("Jet 3 Mass");
  hsig_jet3_m->GetYaxis()->SetTitle("Entries");
  hsig_jet3_m->Scale(1./hsig_jet3_m->Integral());
  hsig_jet3_m->Draw("Ehist,sames");
  hsig_jet3_m->SetLineColor(kRed);
  ...
  hsig_b_jet3_m->Scale(1./hsig_b_jet3_m->Integral());
  ...
  hbkg_b_jet3_m->Scale(1./hbkg_b_jet3_m->Integral());
  ...
  hsig_b_jet4_m->Scale(1./hsig_b_jet4_m->Integral());
  ...
  hbkg_b_jet4_m->Scale(1./hbkg_b_jet4_m->Integral());
  ...
  hbkg_h_pt->Scale(1./hsig_h_pt->Integral());
  ...
  hsig_w_eta->Scale(1./hsig_h_pt->Integral());
  ...
  hbkg_b_jet_mult->Scale(1./hsig_b_jet_mult->Integral());
  ...
  hbkg_dR_jet_muon->Draw("Ehist,sames");
  ...
  hsig_dR_jet_electron->Draw("Ehist");
  ...
  hbkg_dR_jet_electron->Draw("Ehist,sames");
  hbkg_dR_jet_electron->SetLineColor(kRed);
  //delta R after cross-cleaning
  //muon-jet
  TCanvas *c_dR_mn_jet_after = new TCanvas("dR_en_jet_after","dR_en_jet_after",1000,1000);
