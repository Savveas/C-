...
void plots(){
  ...
  TH1F *hbkg_jet1_m_d = (TH1F*)inputfile_back_d->Get("h_jet1_m");
  ...
  TH1F *hbkg_jet2_m_d = (TH1F*)inputfile_back_d->Get("h_jet2_m");
  ...
  TH1F *hbkg_jet3_m_d = (TH1F*)inputfile_back_d->Get("h_jet3_m");
  ...
  TH1F *hbkg_jet4_m_d = (TH1F*)inputfile_back_d->Get("h_jet4_m");
  ...
  TH1F *hbkg_jet1_m_h = (TH1F*)inputfile_back_h->Get("h_jet1_m");
  ...
  TH1F *hbkg_jet2_m_h = (TH1F*)inputfile_back_h->Get("h_jet2_m");
  ...
  TH1F *hbkg_jet3_m_h = (TH1F*)inputfile_back_h->Get("h_jet3_m");
  ...
  TH1F *hbkg_jet4_m_h= (TH1F*)inputfile_back_h->Get("h_jet4_m");
  ...
  TH1F *hbkg_jet1_m_w = (TH1F*)inputfile_back_w->Get("h_jet1_m");
  ...
  TH1F *hbkg_jet2_m_w = (TH1F*)inputfile_back_w->Get("h_jet2_m");
  ...
  TH1F *hbkg_jet3_m_w = (TH1F*)inputfile_back_w->Get("h_jet3_m");
  ...
  TH1F *hbkg_jet4_m_w = (TH1F*)inputfile_back_w->Get("h_jet4_m");
  ...
  TH1F *hbkg_b_jet1_m_h = (TH1F*)inputfile_back_h->Get("h_b_jet1_m");
  ...
  TH1F *hbkg_b_jet2_m_h = (TH1F*)inputfile_back_h->Get("h_b_jet2_m");
  ...
  TH1F *hbkg_b_jet3_m_h = (TH1F*)inputfile_back_h->Get("h_b_jet3_m");
  ...
  TH1F *hbkg_b_jet4_m_h = (TH1F*)inputfile_back_h->Get("h_b_jet4_m");
  ...
  TH1F *hbkg_b_jet1_m_d = (TH1F*)inputfile_back_d->Get("h_b_jet1_m");
  ...
  TH1F *hbkg_b_jet2_m_d = (TH1F*)inputfile_back_d->Get("h_b_jet2_m");
  ...
  TH1F *hbkg_b_jet3_m_d = (TH1F*)inputfile_back_d->Get("h_b_jet3_m");
  ...
  TH1F *hbkg_b_jet4_m_d = (TH1F*)inputfile_back_d->Get("h_b_jet4_m");  
  ...
  TH1F *hbkg_b_jet1_m_w = (TH1F*)inputfile_back_w->Get("h_b_jet1_m");
  ...
  TH1F *hbkg_b_jet2_m_w = (TH1F*)inputfile_back_w->Get("h_b_jet2_m");
  ...
  TH1F *hbkg_b_jet3_m_w = (TH1F*)inputfile_back_w->Get("h_b_jet3_m");
  ...
  TH1F *hbkg_b_jet4_m_w = (TH1F*)inputfile_back_w->Get("h_b_jet4_m");
  ...
  TH1F *hbkg_d_phi_w_b_h_h = (TH1F*)inputfile_back_h->Get("h_d_phi_w_b_h");
  ...
  TH1F *hbkg_d_phi_w_b_h_d = (TH1F*)inputfile_back_d->Get("h_d_phi_w_b_h");
  ...
  TH1F *hbkg_d_phi_w_b_h_w = (TH1F*)inputfile_back_w->Get("h_d_phi_w_b_h");
  ...
  TH1F *hbkg_b_h_pt_h = (TH1F*)inputfile_back_h->Get("h_b_h_pt");
  TH1F *hbkg_b_h_phi_h = (TH1F*)inputfile_back_h->Get("h_b_h_phi");
  TH1F *hbkg_h_eta_h = (TH1F*)inputfile_back_h->Get("h_h_eta");
  TH1F *hbkg_inv_m_h = (TH1F*)inputfile_back_h->Get("h_inv_m");
  TH1F *hbkg_b_inv_m_h = (TH1F*)inputfile_back_h->Get("h_b_inv_m");
  ...
  TH1F *hbkg_b_h_pt_d = (TH1F*)inputfile_back_d->Get("h_b_h_pt");
  TH1F *hbkg_b_h_phi_d = (TH1F*)inputfile_back_d->Get("h_b_h_phi");
  TH1F *hbkg_h_eta_d = (TH1F*)inputfile_back_d->Get("h_h_eta");
  TH1F *hbkg_inv_m_d = (TH1F*)inputfile_back_d->Get("h_inv_m");
  TH1F *hbkg_b_inv_m_d = (TH1F*)inputfile_back_d->Get("h_b_inv_m");
  ...
  TH1F *hbkg_b_h_pt_w = (TH1F*)inputfile_back_w->Get("h_b_h_pt");
  TH1F *hbkg_b_h_phi_w = (TH1F*)inputfile_back_w->Get("h_b_h_phi");
  TH1F *hbkg_h_eta_w = (TH1F*)inputfile_back_w->Get("h_h_eta");
  TH1F *hbkg_inv_m_w = (TH1F*)inputfile_back_w->Get("h_inv_m");
  TH1F *hbkg_b_inv_m_w = (TH1F*)inputfile_back_w->Get("h_b_inv_m");
  ...
  TH1F *hbkg_delta_phi_h = (TH1F*)inputfile_back_h->Get("h_delta_phi");
  TH1F *hbkg_delta_phi_d = (TH1F*)inputfile_back_d->Get("h_delta_phi");
  TH1F *hbkg_delta_phi_w = (TH1F*)inputfile_back_w->Get("h_delta_phi");
  ...
  hbkg_mn_phi_h->Draw("Ehist, sames");
  ...
  hbkg_en_eta_h->Draw("Ehist, sames");
  ...
  hbkg_b_jet3_eta_d->Draw("Ehist,sames");
  ...
  leg_jet4_eta->AddEntry(hbkg_jet4_eta, "Background", "l");
  ...
  leg_b_jet4_eta->AddEntry(hbkg_b_jet4_eta, "Background", "l");
  ...
  leg_jet1_phi->AddEntry(hbkg_jet1_phi, "Background", "l");
  ...
  leg_b_jet1_phi->AddEntry(hbkg_b_jet1_phi, "Background", "l");
  ...
  leg_jet2_phi->AddEntry(hbkg_jet2_phi, "Background", "l");
  ...
  leg_b_jet2_phi->AddEntry(hbkg_b_jet2_phi, "Background", "l");
  ...
  leg_jet3_phi->AddEntry(hbkg_jet3_phi, "Background", "l");
 ...
 TCanvas *c_b_jets3_phi = new TCanvas("b-jets3_phi", "b-jets3_phi", 1000, 1000);
  ...
  leg_b_jet3_phi->AddEntry(hbkg_b_jet3_phi, "Background", "l");
  ...
  leg_jet4_phi->AddEntry(hbkg_jet4_phi, "Background", "l");
  ...
  leg_b_jet4_phi->AddEntry(hbkg_b_jet4_phi, "Background", "l");
  ...
  hbkg_met_pt_h->Draw("Ehist,sames");
  ...
  leg_MET->AddEntry(hbkg_met_pt, "Background", "l");
  ...
  leg_mt->AddEntry(hbkg_mt, "Background", "l");
  ...
  leg_w_h->AddEntry(hbkg_d_phi_w_h, "Background", "l");
  ...
  leg_h_pt->AddEntry(hbkg_h_pt, "Background", "l");
  ...
  hbkg_b_h_pt_h->GetXaxis()->SetTitle("Higgs Transverse Momentum (GeV)");
  hbkg_b_h_pt_h->GetYaxis()->SetTitle("Entries");
  hbkg_b_h_pt_h->SetLineColor(kBlue);
  hbkg_b_h_pt_h->Scale(1. / hbkg_b_h_pt_h->Integral());
  hbkg_b_h_pt_h->Draw("Ehist,sames");

  hbkg_b_h_pt_d->GetXaxis()->SetTitle("Higgs Transverse Momentum (GeV)");
  hbkg_b_h_pt_d->GetYaxis()->SetTitle("Entries");
  hbkg_b_h_pt_d->SetLineColor(kYellow);
  hbkg_b_h_pt_d->Scale(1. / hbkg_b_h_pt_d->Integral());
  hbkg_b_h_pt_d->Draw("Ehist,sames");

  hbkg_b_h_pt_w->GetXaxis()->SetTitle("Higgs Transverse Momentum (GeV)");
  hbkg_b_h_pt_w->GetYaxis()->SetTitle("Entries");
  hbkg_b_h_pt_w->SetLineColor(kGreen);
  hbkg_b_h_pt_w->Scale(1. / hbkg_b_h_pt_w->Integral());
  hbkg_b_h_pt_w->Draw("Ehist,sames");

  TLegend *leg_b_h_pt = new TLegend(0.4, 0.4, 0.5, 0.5);
  leg_b_h_pt->AddEntry(hsig_b_h_pt, "Signal", "l");
  leg_b_h_pt->AddEntry(hbkg_b_h_pt, "Background", "l");
  leg_b_h_pt->AddEntry(hbkg_b_h_pt_h, "TTbar_Hadronic", "l");
  leg_b_h_pt->AddEntry(hbkg_b_h_pt_d, "TTbar_Dileptonic", "l");
  leg_b_h_pt->AddEntry(hbkg_b_h_pt_w, "WJets_to_LNu", "l");
  leg_b_h_pt->Draw();
  ...
  leg_h_phi->AddEntry(hbkg_h_phi, "Background", "l");
  ...
  leg_h_eta->AddEntry(hbkg_h_eta, "Background", "l");
  ...
  leg_inv_m->AddEntry(hbkg_inv_m, "Background", "l");
  ...
  hbkg_b_inv_m_h->GetXaxis()->SetTitle("Higgs mass (after b-tag)");
  hbkg_b_inv_m_h->GetYaxis()->SetTitle("Entries");
  hbkg_b_inv_m_h->SetLineColor(kBlue);
  hbkg_b_inv_m_h->Scale(1. / hbkg_b_inv_m_h->Integral());
  hbkg_b_inv_m_h->Draw("Ehist,sames");

  hbkg_b_inv_m_d->GetXaxis()->SetTitle("Higgs mass (after b-tag)");
  hbkg_b_inv_m_d->GetYaxis()->SetTitle("Entries");
  hbkg_b_inv_m_d->SetLineColor(kYellow);
  hbkg_b_inv_m_d->Scale(1. / hbkg_b_inv_m_d->Integral());
  hbkg_b_inv_m_d->Draw("Ehist,sames");

  TLegend *leg_b_inv_m = new TLegend(0.4, 0.4, 0.5, 0.5);
  leg_b_inv_m->AddEntry(hsig_b_inv_m, "Signal", "l");
  leg_b_inv_m->AddEntry(hbkg_b_inv_m, "Background", "l");
  leg_b_inv_m->AddEntry(hbkg_b_inv_m_h, "TTbar_Hadronic", "l");
  leg_b_inv_m->AddEntry(hbkg_b_inv_m_d, "TTbar_Dileptonic", "l");
  leg_b_inv_m->AddEntry(hbkg_b_inv_m_w, "WJets_to_LNu", "l");
  leg_b_inv_m->Draw();
  ...
  leg_w_pt->AddEntry(hbkg_w_pt, "Background", "l");
  ...
  hbkg_b_jet_mult_d->Draw("Ehist,sames");
  ...
  leg_dR_mn_jet->AddEntry(hbkg_dR_jet_muon_w,"Background","l");
  ...
  leg_dR_en_jet_b->AddEntry(hbkg_dR_jet_electron, "Background", "l");
  ...
  leg_dR_mn_jet_b->AddEntry(hbkg_dR_jet_muon, "Background", "l");
  ...
  leg_dR_jet_en_after_b->AddEntry(hbkg_dR_jet_electron_after,"Background","l");
  ...
  leg_dR_av->AddEntry(hbkg_dR_av,"Background","l");
  ...
  hbkg_delta_phi->Draw("Ehist,sames");

  hbkg_delta_phi_h->GetXaxis()->SetTitle("Minimum azimuthal opening angle");
  hbkg_delta_phi_h->GetYaxis()->SetTitle("Entries");
  hbkg_delta_phi_h->SetLineColor(kBlue);
  hbkg_delta_phi_h->Scale(1./hbkg_delta_phi_h->Integral());
  hbkg_delta_phi_h->Draw("Ehist,sames");

  hbkg_delta_phi_d->GetXaxis()->SetTitle("Minimum azimuthal opening angle");
  hbkg_delta_phi_d->GetYaxis()->SetTitle("Entries");
  hbkg_delta_phi_d->SetLineColor(kYellow);
  hbkg_delta_phi_d->Scale(1./hbkg_delta_phi_d->Integral());
  hbkg_delta_phi_d->Draw("Ehist,sames");

  hbkg_delta_phi_w->GetXaxis()->SetTitle("Minimum azimuthal opening angle");
  hbkg_delta_phi_w->GetYaxis()->SetTitle("Entries");
  hbkg_delta_phi_w->SetLineColor(kGreen);
  hbkg_delta_phi_w->Scale(1./hbkg_delta_phi_w->Integral());
  hbkg_delta_phi_w->Draw("Ehist,sames");

  TLegend *leg_delta_phi = new TLegend(0.4,0.4,0.5,0.5);
  leg_delta_phi->AddEntry(hsig_delta_phi,"Signal","l");
  leg_delta_phi->AddEntry(hbkg_delta_phi,"Background","l");
  leg_delta_phi->AddEntry(hbkg_delta_phi_h,"TTbar_Hadronic","l");
  leg_delta_phi->AddEntry(hbkg_delta_phi_d,"TTbar_Dileptonic","l");
  leg_delta_phi->AddEntry(hbkg_delta_phi_w,"WJets_to_LNu","l");
  leg_delta_phi->Draw();
  ...
  leg_Njets->AddEntry(hbkg_Nbjets_after,"Background","l");
  ...
  leg_btag_0->AddEntry(hbkg_btag_0, "Background", "l");
  ...
  hbkg_btag_1_w->Draw("Ehist,sames");
  ...
  leg_btag_1->AddEntry(hbkg_btag_1, "Background", "l");
  ...
  hbkg_btag_2_d->Draw("Ehist,sames");
  ...
  hbkg_btag_2_w->Draw("Ehist,sames");
  ...
  leg_btag_2->AddEntry(hbkg_btag_2, "Background", "l");
  ...
  hbkg_btag_3_h->SetLineColor(kBlue);
  ...
  hbkg_btag_3_d->Draw("Ehist,sames");
  ...
  hbkg_btag_3_w->Draw("Ehist,sames");
  ...
  leg_btag_3->AddEntry(hbkg_btag_3, "Background", "l");
